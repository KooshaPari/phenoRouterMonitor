...
## [2026.05.0] - 2026-03-29

### Documentation

- Add agent registry and collaboration context framework

### Features

- Add agent worklog tracking system

### Miscellaneous

- Final archive cleanup
- Commit evidence ledger and ignore session artifacts
- Add tach module boundary config and allow tach.toml in gitignore

## [2026.04.0] - 2026-03-29

### Miscellaneous

- Add git-cliff configuration and regenerated CHANGELOG
