...
```bash
agileplus implement WP16 --base WP15
```
...
1. Create `specify.feature`:
   ...
   Feature: Specification workflow
     ...
     Scenario: FR-001 - Specify creates spec in git and SQLite
       ...
       Then a spec.md file exists at "agileplus/test-feature/spec.md"
...
| Timestamp | Event |
|-----------|-------|
| 2026-02-27T00:00:00Z | WP16 prompt generated via /agileplus.tasks |
