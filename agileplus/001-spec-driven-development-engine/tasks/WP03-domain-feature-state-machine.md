...
```bash
agileplus implement WP03 --base WP01
```
...
### Reference Documents
- **Data Model**: `agileplus/001-spec-driven-development-engine/data-model.md` -- Feature entity (lines 73-101), WorkPackage entity (lines 103-124), WP Dependency (lines 213-222)
- **Plan**: `agileplus/001-spec-driven-development-engine/plan.md` -- State machine design (lines 198-210), conflict resolution (lines 244-250)
- **Spec**: `agileplus/001-spec-driven-development-engine/spec.md` -- FR-033 (strict state ordering), FR-034 (skip with warning), FR-038/FR-039 (dependency scheduling)
