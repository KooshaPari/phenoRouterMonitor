...
```bash
agileplus implement WP13 --base WP12
```
...
1. Define the clap subcommand struct:
   ...
   pub struct RetrospectiveArgs {
       ...
       feature: String,
       /// Output file path (default: agileplus/<feature>/retrospective.md)
       #[arg(long)]
       output: Option<PathBuf>,
...
8. Write the report to the output path (default: `agileplus/<feature>/retrospective.md`).
...
| Timestamp | Event |
|-----------|-------|
| 2026-02-27T00:00:00Z | WP13 prompt generated via /agileplus.tasks |
