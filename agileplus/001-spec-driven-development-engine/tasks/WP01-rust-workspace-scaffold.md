...
- **Plan**: `agileplus/001-spec-driven-development-engine/plan.md` -- Project structure (lines 50-176), dependency graph, technical context
- **Data Model**: `agileplus/001-spec-driven-development-engine/data-model.md` -- Entity definitions for domain module stubs
- **Contracts**: `agileplus/001-spec-driven-development-engine/contracts/agileplus.proto` -- gRPC service definitions
