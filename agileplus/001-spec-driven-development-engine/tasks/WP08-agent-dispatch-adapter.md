...
```bash
agileplus implement WP08 --base WP00
```
...
3. Dispatch flow:
   ...
   b. **Copy context files** into worktree: spec.md, plan.md, data-model.md from the feature's agileplus directory.
...
|-----------|--------|-------|---------|
| 2026-02-27T00:00:00Z | Prompt generated | system | WP08 prompt created via /agileplus.tasks |
