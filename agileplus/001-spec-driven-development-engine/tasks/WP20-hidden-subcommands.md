...
`context:load-spec`:
- Required args: `feature_id`.
- Read `agileplus/<feature_id>/spec.md` from disk.
- Emit contents as a fenced markdown block to stdout for agent ingestion.

`context:load-plan`:
- Required args: `feature_id`.
- Read `agileplus/<feature_id>/plan.md` from disk.
...
|---|---|---|---|
| 2026-02-27T00:00:00Z | system | WP created | Generated via /agileplus.tasks |
