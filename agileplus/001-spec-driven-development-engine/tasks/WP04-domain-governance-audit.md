...
```bash
agileplus implement WP04 --base WP03
```
...
### Reference Documents
- **Data Model**: `agileplus/001-spec-driven-development-engine/data-model.md` -- AuditEntry (lines 149-166), GovernanceContract (lines 126-148), Evidence (lines 168-182), PolicyRule (lines 184-197)
- **Plan**: `agileplus/001-spec-driven-development-engine/plan.md` -- Audit chain design (lines 213-224), governance contract model
- **Spec**: `agileplus/001-spec-driven-development-engine/spec.md` -- FR-016 (hash-chained audit), FR-018 (governance contracts), FR-020 (policy rules), FR-021 (evidence linking)
