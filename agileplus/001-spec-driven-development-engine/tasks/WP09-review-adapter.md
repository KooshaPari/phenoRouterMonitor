...
```bash
agileplus implement WP09 --base WP05
```
...
### Key References
- **Spec**: `agileplus/001-spec-driven-development-engine/spec.md` -- FR-012 (review-fix loop), FR-011 (PR description with goal context)
- **Plan**: `agileplus/001-spec-driven-development-engine/plan.md` -- Agent dispatch section, review loop description
- **Data Model**: `agileplus/001-spec-driven-development-engine/data-model.md` -- Evidence entity (type: `review_approval`), WorkPackage.pr_state field
- **Contracts**: `agileplus/001-spec-driven-development-engine/contracts/` -- API contract for review-related endpoints
...
2. **Use CLI**: `agileplus agent tasks move-task WP09 --to <lane> --note "message"` (recommended)
