...
**Inputs**: Design documents from `agileplus/001-spec-driven-development-engine/`
...
- Spec written to git (agileplus/<feature>/spec.md) AND indexed in SQLite
...
- [x] T127 Seed sub-command prompt files from hybridized reference commands (agileplus, bmad, gsd, agileplus superset)
