...
public readonly record struct ResolutionResult
{
    ...
    public IReadOnlyList<DependencyConflict> Conflicts { get; init; } = new List<DependencyConflict>();
    public IReadOnlyList<string> MissingDependencies { get; init; } = new List<string>();
}
