...
//! 2. System config (`/etc/phenotype/<name>.toml`)
//! 3. User config (`~/.config/phenotype/<name>.toml`)
//! 4. Project config (`./<name>.toml`)
//! 5. Environment variables (`PHENOTYPE_<NAME>_<KEY>`)
...
impl ConfigLoader {
    ...
    /// Add a custom search path (checked after defaults, before project).
    pub fn with_path(mut self, path: impl Into<PathBuf>) -> Self {
        // Insert before the last element (project config)
