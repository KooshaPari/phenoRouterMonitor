...
mod tests {
    ...
    // FR-PHENO-007: Jitter adds deterministic variation
    #[tokio::test]
    ...
    async fn test_max_attempts_minimum_clamped() {
        ...
        let result: Result<(), RetryError> = RetryBuilder::default()
            .max_attempts(0)
    ...
    // FR-PHENO-011: Backoff with small base delay
    #[tokio::test]
    ...
    // FR-PHENO-012: Jitter varies per attempt
    #[tokio::test]
    ...
    // FR-PHENO-014: Backoff extreme ranges (1ms to 10s)
    #[tokio::test]
