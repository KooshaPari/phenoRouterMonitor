        ...
        Self {
            rules: vec![
                ClassifierRule {
                    intent: Intent::Bug,
                    keywords: vec![
                        "bug", "error", "crash", "panic", "broken", "fix", "regression",
                        "failing", "failed", "segfault", "exception", "stack trace",
                        "null pointer", "undefined", "404", "500", "timeout",
                ...
                ClassifierRule {
                    ...
                    keywords: vec![
                        ...
                        "support", "enable", "integrate", "endpoint", "api",
                        "should be able to", "want to", "need to",
                    ],
                    weight: 0.9,
                },
                ClassifierRule {
                    intent: Intent::Idea,
                    keywords: vec![
                        "idea", "maybe", "could", "what if", "consider", "explore",
                        "brainstorm", "suggestion", "proposal", "experiment",
                        "would be nice", "nice to have", "someday",
                    ],
                    weight: 0.8,
                },
                ClassifierRule {
                    intent: Intent::Task,
                    keywords: vec![
                        "task", "todo", "refactor", "cleanup", "update", "upgrade",
                        "migrate", "rename", "move", "reorganize", "document",
                        "test", "benchmark", "optimize", "deploy",
                    ],
                    weight: 0.7,
                },
            ],
