...
mod tests {
    ...
    fn test_with_capacity() {
        let result = StringBuilder::with_capacity(100)
            .append("Hello")
            .append_char(' ')
            .append("World")
            .build();
    ...
    #[test]
    fn test_clone() {
        let builder1 = StringBuilder::new().append("Hello");
    ...
    #[test]
    fn test_as_ref() {
        let builder = StringBuilder::new().append("Test");
        let s: &str = builder.as_ref();
        assert_eq!(s, "Test");
    }
    ...
    #[test]
    fn test_repeat_zero() {
        let result = StringBuilder::new().repeat("x", 0).build();
        assert_eq!(result, "");
    }
