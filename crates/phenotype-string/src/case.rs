...
//!
//! Provides methods to convert strings between different case conventions:
...
impl CaseConverter {
    /// Creates a new CaseConverter with the given input string.
