...
//!
//! Provides basic inflection rules for common English pluralization patterns.
//! Supports regular and irregular noun forms.
...
/// - Regular: add 's' or 'es'
/// - Irregular forms: special cases like "child" -> "children"
///
/// # Examples
/// ```
/// use phenotype_string::pluralize;
...
///
/// Handles common English singularization rules.
///
/// # Examples
/// ```
/// use phenotype_string::singularize;
...
/// # Examples
/// ```
/// use phenotype_string::Inflection;
...
impl Inflection {
    /// Creates a new Inflection with the given word.
    ...
    /// Checks if the word is likely plural.
